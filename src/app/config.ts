...
export const countries_mock: Country[] = [
  {
    flag_url:
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/5/52/Flag_of_%C3%85land.svg/22px-Flag_of_%C3%85land.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Flag_of_the_United_States_Virgin_Islands.svg/22px-Flag_of_the_United_States_Virgin_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/8/87/Flag_of_American_Samoa.svg/22px-Flag_of_American_Samoa.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Flag_of_Antarctica.svg/22px-Flag_of_Antarctica.svg.png',
    name_ru: 'Антарктида',
    iso_code2: 'AQ',
    iso_code3: 'ATA',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/8/89/Flag_of_Antigua_and_Barbuda.svg/22px-Flag_of_Antigua_and_Barbuda.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Flag_of_Argentina.svg/22px-Flag_of_Argentina.svg.png',
    name_ru: 'Аргентина',
    iso_code2: 'AR',
    iso_code3: 'ARG',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/16/Flag_of_Afghanistan_%282013%E2%80%932021%29.svg_%28alternative_version_2%29.svg/24px-Flag_of_Afghanistan_%282013%E2%80%932021%29.svg_%28alternative_version_2%29.svg.png',
    name_ru: 'Афганистан',
    iso_code2: 'AF',
    iso_code3: 'AFG',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/93/Flag_of_the_Bahamas.svg/22px-Flag_of_the_Bahamas.svg.png',
    name_ru: 'Багамы',
    iso_code2: 'BS',
    iso_code3: 'BHS',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Flag_of_Bangladesh.svg/22px-Flag_of_Bangladesh.svg.png',
    name_ru: 'Бангладеш',
    iso_code2: 'BD',
    iso_code3: 'BGD',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/de/Flag_of_Bolivia_%28state%29.svg/22px-Flag_of_Bolivia_%28state%29.svg.png',
    name_ru: 'Боливия',
    iso_code2: 'BO',
    iso_code3: 'BOL',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/20/Flag_of_the_Netherlands.svg/22px-Flag_of_the_Netherlands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Flag_of_Bosnia_and_Herzegovina.svg/22px-Flag_of_Bosnia_and_Herzegovina.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Flag_of_the_British_Indian_Ocean_Territory.svg/22px-Flag_of_the_British_Indian_Ocean_Territory.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/42/Flag_of_the_British_Virgin_Islands.svg/22px-Flag_of_the_British_Virgin_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/31/Flag_of_Burkina_Faso.svg/22px-Flag_of_Burkina_Faso.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/00/Flag_of_the_Vatican_City.svg/20px-Flag_of_the_Vatican_City.svg.png',
    name_ru: 'Ватикан',
    iso_code2: 'VA',
    iso_code3: 'VAT',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Flag_of_Venezuela_%28state%29.svg/22px-Flag_of_Venezuela_%28state%29.svg.png',
    name_ru: 'Венесуэла',
    iso_code2: 'VE',
    iso_code3: 'VEN',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/26/Flag_of_East_Timor.svg/22px-Flag_of_East_Timor.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/77/Flag_of_The_Gambia.svg/22px-Flag_of_The_Gambia.svg.png',
    name_ru: 'Гамбия',
    iso_code2: 'GM',
    iso_code3: 'GMB',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/04/Flag_of_Guadeloupe_%28local%29.svg/22px-Flag_of_Guadeloupe_%28local%29.svg.png',
    name_ru: 'Гваделупа',
    iso_code2: 'GP',
    iso_code3: 'GLP',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Flag_of_Guatemala.svg/22px-Flag_of_Guatemala.svg.png',
    name_ru: 'Гватемала',
    iso_code2: 'GT',
    iso_code3: 'GTM',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/29/Flag_of_French_Guiana.svg/22px-Flag_of_French_Guiana.svg.png',
    name_ru: 'Гвиана',
    iso_code2: 'GF',
    iso_code3: 'GUF',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/01/Flag_of_Guinea-Bissau.svg/22px-Flag_of_Guinea-Bissau.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/02/Flag_of_Gibraltar.svg/22px-Flag_of_Gibraltar.svg.png',
    name_ru: 'Гибралтар',
    iso_code2: 'GI',
    iso_code3: 'GIB',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_Greenland.svg/22px-Flag_of_Greenland.svg.png',
    name_ru: 'Гренландия',
    iso_code2: 'GL',
    iso_code3: 'GRL',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Flag_of_the_Dominican_Republic.svg/22px-Flag_of_the_Dominican_Republic.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Flag_of_the_Democratic_Republic_of_the_Congo.svg/22px-Flag_of_the_Democratic_Republic_of_the_Congo.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/26/Flag_of_the_Sahrawi_Arab_Democratic_Republic.svg/22px-Flag_of_the_Sahrawi_Arab_Democratic_Republic.svg.png',
    name_ru: 'САДР',
    iso_code2: 'EH',
    iso_code3: 'ESH',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Flag_of_Indonesia.svg/22px-Flag_of_Indonesia.svg.png',
    name_ru: 'Индонезия',
    iso_code2: 'ID',
    iso_code3: 'IDN',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/38/Flag_of_Cape_Verde.svg/22px-Flag_of_Cape_Verde.svg.png',
    name_ru: 'Кабо-Верде',
    iso_code2: 'CV',
    iso_code3: 'CPV',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Flag_of_Kazakhstan.svg/22px-Flag_of_Kazakhstan.svg.png',
    name_ru: 'Казахстан',
    iso_code2: 'KZ',
    iso_code3: 'KAZ',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Flag_of_the_Cayman_Islands.svg/22px-Flag_of_the_Cayman_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Flag_of_Kyrgyzstan.svg/22px-Flag_of_Kyrgyzstan.svg.png',
    name_ru: 'Киргизия',
    iso_code2: 'KG',
    iso_code3: 'KGZ',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/5/51/Flag_of_North_Korea.svg/22px-Flag_of_North_Korea.svg.png',
    name_ru: 'КНДР',
    iso_code2: 'KP',
    iso_code3: 'PRK',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/74/Flag_of_the_Cocos_%28Keeling%29_Islands.svg/22px-Flag_of_the_Cocos_%28Keeling%29_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/94/Flag_of_the_Comoros.svg/22px-Flag_of_the_Comoros.svg.png',
    name_ru: 'Коморы',
    iso_code2: 'KM',
    iso_code3: 'COM',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Flag_of_Costa_Rica_%28state%29.svg/22px-Flag_of_Costa_Rica_%28state%29.svg.png',
    name_ru: 'Коста-Рика',
    iso_code2: 'CR',
    iso_code3: 'CRI',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Flag_of_C%C3%B4te_d%27Ivoire.svg/22px-Flag_of_C%C3%B4te_d%27Ivoire.svg.png',
    name_ru: 'Кот-д’Ивуар',
    iso_code2: 'CI',
    iso_code3: 'CIV',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Flag_of_Cura%C3%A7ao.svg/22px-Flag_of_Cura%C3%A7ao.svg.png',
    name_ru: 'Кюрасао',
    iso_code2: 'CW',
    iso_code3: 'CUW',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/11/Flag_of_Lithuania.svg/22px-Flag_of_Lithuania.svg.png',
    name_ru: 'Литва',
    iso_code2: 'LT',
    iso_code3: 'LTU',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/47/Flag_of_Liechtenstein.svg/22px-Flag_of_Liechtenstein.svg.png',
    name_ru: 'Лихтенштейн',
    iso_code2: 'LI',
    iso_code3: 'LIE',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/da/Flag_of_Luxembourg.svg/22px-Flag_of_Luxembourg.svg.png',
    name_ru: 'Люксембург',
    iso_code2: 'LU',
    iso_code3: 'LUX',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/77/Flag_of_Mauritius.svg/22px-Flag_of_Mauritius.svg.png',
    name_ru: 'Маврикий',
    iso_code2: 'MU',
    iso_code3: 'MUS',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/43/Flag_of_Mauritania.svg/22px-Flag_of_Mauritania.svg.png',
    name_ru: 'Мавритания',
    iso_code2: 'MR',
    iso_code3: 'MRT',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Flag_of_Madagascar.svg/22px-Flag_of_Madagascar.svg.png',
    name_ru: 'Мадагаскар',
    iso_code2: 'MG',
    iso_code3: 'MDG',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Flag_of_Mayotte_%28local%29.svg/22px-Flag_of_Mayotte_%28local%29.svg.png',
    name_ru: 'Майотта',
    iso_code2: 'YT',
    iso_code3: 'MYT',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Flag_of_Macedonia.svg/22px-Flag_of_Macedonia.svg.png',
    name_ru: 'Македония',
    iso_code2: 'MK',
    iso_code3: 'MKD',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/5/52/Flag_of_Martinique.svg/22px-Flag_of_Martinique.svg.png',
    name_ru: 'Мартиника',
    iso_code2: 'MQ',
    iso_code3: 'MTQ',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Flag_of_the_Marshall_Islands.svg/22px-Flag_of_the_Marshall_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Flag_of_the_Federated_States_of_Micronesia.svg/22px-Flag_of_the_Federated_States_of_Micronesia.svg.png',
    name_ru: 'Микронезия',
    iso_code2: 'FM',
    iso_code3: 'FSM',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Flag_of_Mozambique.svg/22px-Flag_of_Mozambique.svg.png',
    name_ru: 'Мозамбик',
    iso_code2: 'MZ',
    iso_code3: 'MOZ',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Flag_of_Montserrat.svg/22px-Flag_of_Montserrat.svg.png',
    name_ru: 'Монтсеррат',
    iso_code2: 'MS',
    iso_code3: 'MSR',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/19/Flag_of_Nicaragua.svg/22px-Flag_of_Nicaragua.svg.png',
    name_ru: 'Никарагуа',
    iso_code2: 'NI',
    iso_code3: 'NIC',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Flag_of_New_Zealand.svg/22px-Flag_of_New_Zealand.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/23/Flag_of_New_Caledonia.svg/22px-Flag_of_New_Caledonia.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Flag_of_the_Isle_of_Mann.svg/22px-Flag_of_the_Isle_of_Mann.svg.png',
    name_ru: 'Остров Мэн',
    iso_code2: 'IM',
    iso_code3: 'IMN',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/35/Flag_of_the_Cook_Islands.svg/22px-Flag_of_the_Cook_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/48/Flag_of_Norfolk_Island.svg/22px-Flag_of_Norfolk_Island.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/67/Flag_of_Christmas_Island.svg/22px-Flag_of_Christmas_Island.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_the_Pitcairn_Islands.svg/22px-Flag_of_the_Pitcairn_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/00/Flag_of_Saint_Helena.svg/22px-Flag_of_Saint_Helena.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/00/Flag_of_Palestine.svg/22px-Flag_of_Palestine.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Flag_of_Papua_New_Guinea.svg/22px-Flag_of_Papua_New_Guinea.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/df/Flag_of_Peru_%28state%29.svg/22px-Flag_of_Peru_%28state%29.svg.png',
    name_ru: 'Перу',
    iso_code2: 'PE',
    iso_code3: 'PER',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/2/28/Flag_of_Puerto_Rico.svg/22px-Flag_of_Puerto_Rico.svg.png',
    name_ru: 'Пуэрто-Рико',
    iso_code2: 'PR',
    iso_code3: 'PRI',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/92/Flag_of_the_Republic_of_the_Congo.svg/22px-Flag_of_the_Republic_of_the_Congo.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/22px-Flag_of_South_Korea.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/ru/thumb/8/84/Regional_Flag_of_Reunion.gif/22px-Regional_Flag_of_Reunion.gif',
    name_ru: 'Реюньон',
    iso_code2: 'RE',
    iso_code3: 'REU',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/34/Flag_of_El_Salvador.svg/22px-Flag_of_El_Salvador.svg.png',
    name_ru: 'Сальвадор',
    iso_code2: 'SV',
    iso_code3: 'SLV',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Flag_of_San_Marino.svg/22px-Flag_of_San_Marino.svg.png',
    name_ru: 'Сан-Марино',
    iso_code2: 'SM',
    iso_code3: 'SMR',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Flag_of_Sao_Tome_and_Principe.svg/22px-Flag_of_Sao_Tome_and_Principe.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Flag_of_Saudi_Arabia.svg/22px-Flag_of_Saudi_Arabia.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Flag_of_Swaziland.svg/22px-Flag_of_Swaziland.svg.png',
    name_ru: 'Свазиленд',
    iso_code2: 'SZ',
    iso_code3: 'SWZ',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Flag_of_the_Northern_Mariana_Islands.svg/22px-Flag_of_the_Northern_Mariana_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Flag_of_Seychelles.svg/22px-Flag_of_Seychelles.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/df/Flag_of_Saint_Barthelemy_%28local%29.svg/22px-Flag_of_Saint_Barthelemy_%28local%29.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Flag_of_Saint-Martin_%28fictional%29.svg/22px-Flag_of_Saint-Martin_%28fictional%29.svg.png',
    name_ru: 'Сен-Мартен',
    iso_code2: 'MF',
    iso_code3: 'MAF',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/74/Flag_of_Saint-Pierre_and_Miquelon.svg/22px-Flag_of_Saint-Pierre_and_Miquelon.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Flag_of_Saint_Vincent_and_the_Grenadines.svg/22px-Flag_of_Saint_Vincent_and_the_Grenadines.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Flag_of_Saint_Kitts_and_Nevis.svg/22px-Flag_of_Saint_Kitts_and_Nevis.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Flag_of_Saint_Lucia.svg/22px-Flag_of_Saint_Lucia.svg.png',
    name_ru: 'Сент-Люсия',
    iso_code2: 'LC',
    iso_code3: 'LCA',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Flag_of_Sint_Maarten.svg/22px-Flag_of_Sint_Maarten.svg.png',
    name_ru: 'Синт-Мартен',
    iso_code2: 'SX',
    iso_code3: 'SXM',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/74/Flag_of_the_Solomon_Islands.svg/22px-Flag_of_the_Solomon_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Flag_of_the_Soviet_Union.svg/22px-Flag_of_the_Soviet_Union.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/17/Flag_of_Sierra_Leone.svg/22px-Flag_of_Sierra_Leone.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Flag_of_Tajikistan.svg/22px-Flag_of_Tajikistan.svg.png',
    name_ru: 'Таджикистан',
    iso_code2: 'TJ',
    iso_code3: 'TJK',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Flag_of_the_Turks_and_Caicos_Islands.svg/22px-Flag_of_the_Turks_and_Caicos_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/64/Flag_of_Trinidad_and_Tobago.svg/22px-Flag_of_Trinidad_and_Tobago.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Flag_of_Turkmenistan.svg/22px-Flag_of_Turkmenistan.svg.png',
    name_ru: 'Туркмения',
    iso_code2: 'TM',
    iso_code3: 'TKM',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/8/84/Flag_of_Uzbekistan.svg/22px-Flag_of_Uzbekistan.svg.png',
    name_ru: 'Узбекистан',
    iso_code2: 'UZ',
    iso_code3: 'UZB',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Flag_of_the_Faroe_Islands.svg/22px-Flag_of_the_Faroe_Islands.svg.png',
    name_ru: 'Фареры',
    iso_code2: 'FO',
    iso_code3: 'FRO',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/9/99/Flag_of_the_Philippines.svg/22px-Flag_of_the_Philippines.svg.png',
    name_ru: 'Филиппины',
    iso_code2: 'PH',
    iso_code3: 'PHL',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/8/83/Flag_of_the_Falkland_Islands.svg/22px-Flag_of_the_Falkland_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/d/db/Flag_of_French_Polynesia.svg/22px-Flag_of_French_Polynesia.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Flag_of_the_French_Southern_and_Antarctic_Lands.svg/22px-Flag_of_the_French_Southern_and_Antarctic_Lands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Flag_of_the_Central_African_Republic.svg/22px-Flag_of_the_Central_African_Republic.svg.png',
    name_ru: 'ЦАР',
    iso_code2: 'CF',
    iso_code3: 'CAF',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/6/64/Flag_of_Montenegro.svg/22px-Flag_of_Montenegro.svg.png',
    name_ru: 'Черногория',
    iso_code2: 'ME',
    iso_code3: 'MNE',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Flag_of_the_Czech_Republic.svg/22px-Flag_of_the_Czech_Republic.svg.png',
    name_ru: 'Чехия',
    iso_code2: 'CZ',
    iso_code3: 'CZE',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Flag_of_Switzerland.svg/20px-Flag_of_Switzerland.svg.png',
    name_ru: 'Швейцария',
    iso_code2: 'CH',
    iso_code3: 'CHE',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/1/11/Flag_of_Sri_Lanka.svg/22px-Flag_of_Sri_Lanka.svg.png',
    name_ru: 'Шри-Ланка',
    iso_code2: 'LK',
    iso_code3: 'LKA',
  },
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/3/31/Flag_of_Equatorial_Guinea.svg/22px-Flag_of_Equatorial_Guinea.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/a/af/Flag_of_South_Africa.svg/22px-Flag_of_South_Africa.svg.png',
    name_ru: 'ЮАР',
    iso_code2: 'ZA',
    iso_code3: 'ZAF',
  },
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Flag_of_South_Georgia_and_the_South_Sandwich_Islands.svg/22px-Flag_of_South_Georgia_and_the_South_Sandwich_Islands.svg.png',
  ...
  {
    flag_url:
      '//upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Flag_of_South_Sudan.svg/22px-Flag_of_South_Sudan.svg.png',
    name_ru: 'Южный Судан',
    iso_code2: 'SS',
    iso_code3: 'SSD',
  },
